...
export interface Client {
   ...
   */
  init: ({title, poll_options}: {title: string, poll_options: Array<string>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAADhJbml0aWFsaXplcyB0aGUgcG9sbCB3aXRoIGEgdGl0bGUgYW5kIGEgbGlzdCBvZiBvcHRpb25zLgAAAARpbml0AAAAAgAAAAAAAAAFdGl0bGUAAAAAAAAQAAAAAAAAAAxwb2xsX29wdGlvbnMAAAPqAAAAEAAAAAEAAAPpAAAD7QAAAAAAAAAD",
